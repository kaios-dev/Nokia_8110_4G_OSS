...
pref("geo.wifi.uri", "https://api.stage.kaiostech.com/v3.0/lbs/locate");
...
// Enable slide manager
pref("dom.slide.enabled", true);
...
// FR4238-shiyanluo@t2mobile.com-for complying KaiOS Store-begin
...
pref("device.cuRef.default", "4044O-2AAQUS1");
// FR4238-shiyanluo@t2mobile.com-for complying KaiOS Store-end
...
pref("fota.server.protocol", "http");
pref("fota.server.port", "80");
pref("fota.workspace.path", "/data/fota");
pref("oem.software.version", "14.00.17.10");
pref("fota.commercial.ref", "TA1067-AAROW1SS");
pref("device.commercial.ref", "TA1067-AAROW1SS");
