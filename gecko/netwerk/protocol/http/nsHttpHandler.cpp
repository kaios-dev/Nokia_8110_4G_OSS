...
nsHttpHandler::AddStandardRequestHeaders(nsHttpHeaderArray *request, bool isSecure)
{
    ...
    // Add the "X-WAP-Profile" header
    rv = request->SetHeader(nsHttp::X_WAP_Profile, NS_LITERAL_CSTRING("http://useragentprofile.hmdglobal.com/uaprof/Nokia81104Gr100.xml"),
                            false, nsHttpHeaderArray::eVarietyDefault);
...
nsHttpHandler::BuildUserAgent()
{
    ...
    mProductModel.AssignLiteral("Nokia_8110_4G");
