...
#include "mozilla/dom/SlideManager.h"
/*add by xuejiang.liu for Argon Slider Feature for task:5218350*/
...
/*add by xuejiang.liu for Argon Slider Feature for task:5218350*/
/**
 * Inform the Slidemanager backend there is a new flip observer.
 * @param aSlideObserver The observer that should be added.
 */
void RegisterSlideObserver(mozilla::dom::SlideObserver* aSlideObserver);
/*add by xuejiang.liu for Argon Slider Feature for task:5218350*/
...
/*add by xuejiang.liu for Argon Slider Feature for task:5218350*/
/**
 * Inform the Slidemanager backend a flip observer unregistered.
 * @param aPowerSupplyObserver The observer that should be removed.
 */
void UnregisterSlideObserver(mozilla::dom::SlideObserver* aSlideObserver);
/*add by xuejiang.liu for Argon Slider Feature for task:5218350*/
...
/*add by xuejiang.liu for Argon Slider Feature for task:5218350*/
/**
 * Notify of a change in the Slide state from input device.
 * @param aSlideState The new flip state.
 */
void NotifySlideStateFromInputDevice(long aSlideState);
/*add by xuejiang.liu for Argon Slider Feature for task:5218350*/
...
/*add by xuejiang.liu for Argon Slider Feature for task:5218350*/
/**
 * Request the current Slide state. If the request is made by content process,
 * result will be returned asynchronously.
 */
void RequestCurrentSlideState();
/*add by xuejiang.liu for Argon Slider Feature for task:5218350*/
...
/*add by xuejiang.liu for Argon Slider Feature for task:5218350*/
/**
 * Update the Slide state in each flip observers.
 * @param aSlideState The new flip state.
 */
void UpdateSlideState(const long& aSlideState);
/*add by xuejiang.liu for Argon Slider Feature for task:5218350*/
