...
/**
 * Enables powersupply notifications from the backend.
 */
void EnablePowerSupplyNotifications();

/**
 * Disables powersupply notifications from the backend.
 */
...
/**
 * Enable Slide state change notifications from the backend.
 */
void EnableSlideNotifications();

/**
 * Disable Slide state change notifications from the backend.
 */
void DisableSlideNotifications();
/*add by xuejiang.liu for Argon Slider Feature for task:5218350*/
/**
