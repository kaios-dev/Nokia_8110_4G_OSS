...
TelephonyAudioService.prototype = {
  ...
  set micMode(aMicMode) {
   dump("telephonyAudioservice aMicMode is "+aMicMode);
    // if (aMicMode == this._micMode) {
    //   return;
    // }
    this._micMode = aMicMode;
    gAudioManager.setMicMode(aMicMode);
  },
