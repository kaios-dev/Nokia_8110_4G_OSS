...
interface MozWifiManager : EventTarget {
  ...
  /**
   * task-5206929 modify by shangpeng.su 2017.08.23
   * Save a wifi config
   * @param network a network which will be saved.
   * onsuccess: We have successfully save wifi config.
   * onerror: We have failed to save wifi config.
   */
  DOMRequest saveNetworkConfigurated(MozWifiNetwork network);
