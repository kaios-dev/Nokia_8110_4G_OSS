...
DOMWifiManager.prototype = {
  ...
  init: function(aWindow) {
    ...
    const messages = ["WifiManager:getNetworks:Return:OK", "WifiManager:getNetworks:Return:NO",
                      ...
                      "WifiManager:saveNetworkConfigurated:Return:OK", "WifiManager:saveNetworkConfigurated:Return:NO",
  ...
  receiveMessage: function(aMessage) {
    ...
    switch (aMessage.name) {
      ...
      case "WifiManager:saveNetworkConfigurated:Return:OK":
        Services.DOMRequest.fireSuccess(request, msg.data);
        break;

      case "WifiManager:saveNetworkConfigurated:Return:NO":
        Services.DOMRequest.fireError(request, msg.data);
        break;
  ...
  //[task-5206929] modify by shangpeng.su 2017.08.23 begin
  saveNetworkConfigurated: function saveNetworkConfigurated(network) {
    var request = this.createRequest();
    this._sendMessageForRequest("WifiManager:saveNetworkConfigurated",
                                this._convertWifiNetworkToJSON(network), request);
    return request;
  },
  //[task-5206929] modify end
