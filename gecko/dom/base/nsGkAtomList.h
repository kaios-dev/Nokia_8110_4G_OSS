...
GK_ATOM(_and, "and")
GK_ATOM(animationmode, "animationmode")
...
GK_ATOM(onbatteryhealthchange, "onbatteryhealthchange")
...
GK_ATOM(oncallsessionevent, "oncallsessionevent")
GK_ATOM(oncancel, "oncancel")
GK_ATOM(oncapabilitychange, "oncapabilitychange")
GK_ATOM(oncardstatechange, "oncardstatechange")
GK_ATOM(oncfstatechange, "oncfstatechange")
GK_ATOM(onchange, "onchange")
GK_ATOM(onchangecameracapabilities, "onchangecameracapabilities")
GK_ATOM(onchangepeerdimensions, "onchangepeerdimensions")
GK_ATOM(oncharacteristicchanged, "oncharacteristicchanged")
GK_ATOM(onchangevideoquality, "onchangevideoquality")
...
GK_ATOM(onflashlightchange, "onflashlightchange")
GK_ATOM(onflipchange, "onflipchange")
...
GK_ATOM(onsignalstrengthchange, "onsignalstrengthchange")
...
GK_ATOM(onlargetextenabledchanged, "onlargetextenabledchanged")
...
GK_ATOM(onpbapconnectionreq, "onpbapconnectionreq")
GK_ATOM(onpopstate, "onpopstate")
GK_ATOM(only, "only")               // this one is not an event
GK_ATOM(onmapconnectionreq, "onmapconnectionreq")
...
GK_ATOM(onpowersupplystatuschanged, "onpowersupplystatuschanged")
...
GK_ATOM(onringbacktone, "onringbacktone")
...
GK_ATOM(onslidechange, "onslidechange")
...
GK_ATOM(onttymodereceived, "onttymodereceived")
...
GK_ATOM(onusbstatuschange, "onusbstatuschange")
...
GK_ATOM(ontelephonycoveragelosing, "ontelephonycoveragelosing")
GK_ATOM(open, "open")
...
GK_ATOM(onsessionmodifyrequest, "onsessionmodifyrequest")
GK_ATOM(onsessionmodifyresponse, "onsessionmodifyresponse")
