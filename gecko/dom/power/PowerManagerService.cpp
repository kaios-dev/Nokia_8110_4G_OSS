...
//JWJ: Add 2 head files for ARG-988
#include "../system/gonk/android_audio/AudioSystem.h"
...
PowerManagerService::PowerOffFinal()
{
  ...
  SyncProfile();
  //JWJ: Fix ARG-988 shutdown audio before power off ---BEGIN
  android::String8 cmd("dev_shutdown=true");
  android::AudioSystem::setParameters(0, cmd);
  //JWJ: Fix ARG-988 shutdown audio before power off ---END
  hal::PowerOff();
